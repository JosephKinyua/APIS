    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[('Tunisia Food', 'Tunisia Food'), ('Ghana Food', 'Ghana Food'), ('Somalian Food', 'Somalian Food'), ('Kenyan Food', 'Kenyan Food'), ('Food', 'Food')], max_length=50)),
